...
//total prodcut show 
(async function(){
  let data = await fetch('https://jso-nis-live-again-6govfacc3-abhay-dixits-projects-4f073080.vercel.app/Product');
...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    const response = await fetch('https://jso-nis-live-again-6govfacc3-abhay-dixits-projects-4f073080.vercel.app/Product');
